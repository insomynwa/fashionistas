...
get_header(); ?>
  ...
  <div>
    ...
    <div class="spasi"></div>
      <div class="row">
        <div class="col-md-4"><img width="100%" height="200" src="images/1.png">
        ...
        <div class="col-md-4"><img width="100%" height="200" src="images/2.png">
        ...
        <div class="col-md-4"><img width="100%" height="200" src="images/3.png">
